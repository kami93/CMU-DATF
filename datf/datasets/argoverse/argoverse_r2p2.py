...
def argoverse_collate_R2P2(batch, test_set=False):
    # batch_i:
...
class ArgoverseDataset_R2P2(Dataset):
    def __init__(self, cfg, data_partition, map_version, **kwargs):
        ...
        """
        super(ArgoverseDataset_R2P2, self).__init__()
        self.cfg = cfg 
    ...
    def __getitem__(self, idx):
        ...
        if self.use_scene:
            ...
            if self.map_version == '1.3':
                ...
                if not isinstance(self.scene_size, tuple): self.scene_size = tuple(self.scene_size)
